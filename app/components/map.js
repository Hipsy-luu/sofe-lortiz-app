...
export default class MapComponent extends Component {
  ...
  async didInsertElement() {
    ...
    let chart = am4core.create("chartdiv11", am4maps.MapChart);
    await this.api.sleep(2500);

    chart.paddingRight = 20;


    let title = chart.titles.create();
    title.text = "[bold font-size: 20][/]\nsource: http://api.coronastatistics.live";
    title.textAlign = "middle";

    let mapData = [];
    let defaultData = [
      { "id": "AF", "name": "Afghanistan", "value": 20, "color": chart.colors.getIndex(0) },
      { "id": "AL", "name": "Albania", "value": 50000, "color": chart.colors.getIndex(1) },
      ...
      { "id": "DO", "name": "", "value": 10056181, "color": chart.colors.getIndex(4) },
      ...
      { "id": "HK", "name": "Hong Kong", "value": 7122187, "color": chart.colors.getIndex(0) },
      ...
      { "id": "KR", "name": "S. Korea", "value": 48391343, "color": chart.colors.getIndex(0) },
      ...
      { "id": "MK", "name": "North Macedonia", "value": 2063893, "color": chart.colors.getIndex(1) },
      ...
      { "id": "NL", "name": "Caribbean Netherlands", "value": 16664746, "color": chart.colors.getIndex(1) },
      ...
      { "id": "SD", "name": "South Sudan", "value": 34735288, "color": chart.colors.getIndex(2) },
      ...
      { "id": "US", "name": "USA", "value": 313085380, "color": chart.colors.getIndex(4) },
    ...
    /* console.log(this.api.allCountriesData); */

    //Se hace una cruza de los datos 
    await this.api.allCountriesData.forEach(element => {
      const found = defaultData.find(elementdefault => elementdefault.name == element.country);
      if(found){
        mapData.push({ "id": found.id, "name": found.name, "value": element.cases, "color": found.color });
      }else{
